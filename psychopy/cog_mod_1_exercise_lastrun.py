...
expName = 'cog_mod_1_exercise'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/emil/Desktop/DTU Engineering Acoustics/02458 Cognitive Modelling/Cog_Mod_1_exercise/cog_mod_1_exercise_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    intro = visual.TextStim(win=win, name='intro',
        text='This is an experiment to see how well you can spot the differences.\n\n\nKresmir & Emil',
        font='Arial',
    ...
    # --- Run Routine "intro_2" ---
    thisExp.currentRoutine = intro_2
    ...
    while continueRoutine:
        ...
        if intro_2.forceEnded or routineForceEnded:
            break
